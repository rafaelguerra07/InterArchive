        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <br><center><p class="lead text-muted">Cria já uma conta para não teres problemas como o Rafael xD</p></center>
						<center><a href="reg_login.php" class="btn btn-primary btn-lg">Criar Conta</a></center>
                </div>                
